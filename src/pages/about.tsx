    ...
    <Layout location={location}>
      <div className="about-container">
        ...
        <p>
          ...
          drawing skills peaked in Kindergarten but, in looking back, the reason I was drawn to that career is that you get to dream something up, 
          plan it out, and then go forth and make it happen until you have something long-lasting to show for it.
          It is this same set of motivating factors that has led me to web development -- it offers a unique opportunity 
        ...
        <p>
          Outside of coding, you can find me basketball, relaxing with my wife, daughter, and dog, and playing the electric guitar on YouTube.
        </p>
      </div>
    </Layout>
  );
